package com.bluebeaniestudio.example.bitcoin.main;
...
/**
 * Created by Unni Mana on 18/07/2018.
 */
public class BitcoinActivity extends AppCompatActivity {

    /** logger **/
    private static final String TAG = BitcoinActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(BitcoinActivity.this);
...
//
        ...
        builder = new AlertDialog.Builder(BitcoinActivity.this);
